  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "benefit-card-1": "url(assets/projects/card-1.svg)",
        "benefit-card-2": "url(assets/projects/card-2.svg)",
        "benefit-card-3": "url(assets/projects/card-3.svg)",
        "benefit-card-4": "url(assets/projects/card-4.svg)",
        "benefit-card-5": "url(assets/projects/card-5.svg)",
        "benefit-card-6": "url(assets/projects/card-6.svg)",
      },
    },
  },
  plugins: [
